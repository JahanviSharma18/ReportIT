...
>
  ...
  <img
    ...
    alt="Moving Guard"
    className="absolute w-10 md:w-20 h-auto pointer-events-none transition-transform duration-100 ease-out z-[5] opacity-90"
    style={{
      left: 0, 
      top: 0,
  ...
  "
>
  {role ? "My Dashboard" : "Report an Incident"}
</Link>
